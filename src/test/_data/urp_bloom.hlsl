#line 1 "Hidden/Universal Render Pipeline/Bloom"
static const int _USE_RGBM = 0 ;
static const int _BLOOM_HQ = 0 ;
...
#line 14 "D:/unity/BoatAttack/Library/PackageCache/com.unity.render-pipelines.core@15.0.1/ShaderLibrary/Filtering.hlsl"
...
#line 89
half3 color = _BlitTexture . SampleBias ( sampler_LinearClamp , uv , _GlobalMipBias . x ) . xyz ;
#line 93
color = min ( _Params . y , color ) ;
#line 96
half brightness = Max3 ( color . r , color . g , color . b ) ;
half softness = clamp ( brightness - _Params . z + _Params . w , 0.0 , 2.0 * _Params . w ) ;
softness = ( softness * softness ) / ( 4.0 * _Params . w + 1e-4 ) ;
half multiplier = max ( brightness - _Params . z , softness ) / max ( brightness , 1e-4 ) ;
color *= multiplier ;
#line 103
color = max ( color , 0 ) ;
...
float2 uv = input . texcoord ;
#line 114
half3 c0 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , uv - float2 ( texelSize * 4.0 , 0.0 ) , _GlobalMipBias . x ) ) ;
half3 c1 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , uv - float2 ( texelSize * 3.0 , 0.0 ) , _GlobalMipBias . x ) ) ;
half3 c2 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , uv - float2 ( texelSize * 2.0 , 0.0 ) , _GlobalMipBias . x ) ) ;
half3 c3 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , uv - float2 ( texelSize * 1.0 , 0.0 ) , _GlobalMipBias . x ) ) ;
half3 c4 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , uv , _GlobalMipBias . x ) ) ;
half3 c5 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , uv + float2 ( texelSize * 1.0 , 0.0 ) , _GlobalMipBias . x ) ) ;
half3 c6 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , uv + float2 ( texelSize * 2.0 , 0.0 ) , _GlobalMipBias . x ) ) ;
half3 c7 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , uv + float2 ( texelSize * 3.0 , 0.0 ) , _GlobalMipBias . x ) ) ;
half3 c8 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , uv + float2 ( texelSize * 4.0 , 0.0 ) , _GlobalMipBias . x ) ) ;
...
float2 uv = input . texcoord ;
#line 138
half3 c0 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , uv - float2 ( 0.0 , texelSize * 3.23076923 ) , _GlobalMipBias . x ) ) ;
half3 c1 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , uv - float2 ( 0.0 , texelSize * 1.38461538 ) , _GlobalMipBias . x ) ) ;
half3 c2 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , uv , _GlobalMipBias . x ) ) ;
half3 c3 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , uv + float2 ( 0.0 , texelSize * 1.38461538 ) , _GlobalMipBias . x ) ) ;
half3 c4 = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , uv + float2 ( 0.0 , texelSize * 3.23076923 ) , _GlobalMipBias . x ) ) ;
...
{
half3 highMip = DecodeHDR ( _BlitTexture . SampleBias ( sampler_LinearClamp , uv , _GlobalMipBias . x ) ) ;
#line 158
half3 lowMip = DecodeHDR ( _SourceTexLowMip . SampleBias ( sampler_LinearClamp , uv , _GlobalMipBias . x ) ) ;
#line 161
